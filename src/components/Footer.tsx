        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-sm text-gray-400 mb-4">
              AI-powered job matching platform connecting talented professionals with
              the right opportunities. Built for the future of work.
            </p>
